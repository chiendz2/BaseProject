# AGENTS.md — loader (Codex & any other agent)
...
Applies to **every** agent working here — Codex, Claude Code, Antigravity / Gemini, Cursor, Copilot, sub-agents, and code written through **Unity MCP**.
